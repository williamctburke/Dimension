...
class Main:
    ...
    def __init__(self):
        ...
        self.sht3 = xw.Book.caller().sheets[2] # dimension data sheet, optionally filled with observations
    ...
    def simulate(self):
        ...
        for dim in self.dimensions:
            dim.set_sample(Main.sample_count) # The distributions for each dim are populated in the read() method
        self.update()
